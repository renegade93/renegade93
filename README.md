...
## 頑張って。  
*“Do your best.” — but make it sustainable.*
...
I ship software that works, scales, and doesn’t require rituals to keep alive.
...
### 🎧
[![spotify-github-profile](https://spotify-github-profile.kittinanx.com/api/view?uid=125208069&cover_image=true&theme=default&show_offline=false&background_color=121212&interchange=false&profanity=false&hide_remaster=false)](https://github.com/kittinan/spotify-github-profile)
...
- **Frontend** → React + TypeScript dashboards admins rely on *(and complain about)*
- **Backend** → Rails APIs, auth, permissions, and keeping data from lying
- **Integrations** → Turning CSVs and third-party chaos into something usable
- **Infra-ish** → Deploying, watching logs, and negotiating with production
- **Data** → SQL, dashboards, and explaining numbers no one trusts at first

I care about:
- Clean abstractions  
- Shipping > theorizing  
- Code that survives handoff  
- UX that respects users  
